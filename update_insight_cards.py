...
path = Path(r"C:\Users\US\Downloads\index_pricing_bundles_added.html")
text = path.read_text(encoding="utf-8")

css_anchor = "        .glass-card:hover {\n            border-color: rgba(212,175,55,0.3);\n            box-shadow: 0 0 30px rgba(212,175,55,0.1), 0 20px 60px rgba(0,0,0,0.5);\n            transform: translateY(-8px);\n        }\n"
css_extra = """
...
script_anchor = "        // Floating Particles\n"
script_extra = """        const insightContent = {
...
text = text.replace(script_anchor, script_extra, 1)
